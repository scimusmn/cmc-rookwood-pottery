...
exports.createPages = async ({ actions, graphql }) => {
  ...
  const {
    ...
    data: {
      allRookwoodPotteryInteractiveData,
    },
  } = await graphql(`
    {
      allRookwoodPotteryInteractiveData: allContentfulRookwoodPotteryInteractive {
        edges {
          node {
            slug
          }
  ...
  const pageTypes = [
    {
      entries: allRookwoodPotteryInteractiveData.edges,
      slugPrefix: '/',
      template: './src/templates/RookwoodPotteryInteractive/index.js',
    },
  ];
