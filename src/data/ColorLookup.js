const COLOR_LOOKUP = {
  ...
  Devon: { label: 'Devon', before: '#ecd9ae', after: '#706843' },
  ...
  Light_brown_Pinecone_vase: { label: 'Pinecone vase brown', before: '#ada8a4', after: '#140c0a' },
  Light_brown_Tree_of_Life: { label: 'Tree of life brown', before: '#d28573', after: '#675b4f' },
  ...
  Tuscan_Gold: { label: 'Tuscan Gold', before: '#8c6433', after: '#c18a75' },
